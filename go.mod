module benthos-testing

go 1.21

require (
	github.com/LearningMotors/go-genproto v0.0.0-20231228090422-a51cc00b3baf
	github.com/LearningMotors/nms-property-engine v0.0.0-20230911120058-ba25a3960e87
	github.com/LearningMotors/platform v1.3.18
